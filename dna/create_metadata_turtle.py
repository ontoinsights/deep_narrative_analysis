...
def create_metadata_turtle(narrative: str, narr_metadata: dict) -> (str, dict, str, list):
    ...
    # Get additional information - the subject's birthdate, place and the names of family members
...
def get_birth_family_turtle(narrative: str, given_name: str, iri_narrator: str) -> (list, dict):
    ...
    :returns: List holding strings of the new triples to add and a dictionary containing the names
...
def get_narrator_names(narr_metadata: dict) -> str:
    ...
    :returns: String holding names ('labels') for the narrator/subject, separated appropriately
