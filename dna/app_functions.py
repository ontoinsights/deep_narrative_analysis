...
def process_background(entities: list, repo: str) -> BackgroundAndNarrativeResults:
    ...
    for entity in entities:
        if entity['type'].lower() in ('law', 'organization', 'person', 'place', 'thing'):
...
def process_new_narrative(metadata: Metadata, narr: str, repo: str) -> BackgroundAndNarrativeResults:
    ...
    if msg:
        ...
        return NarratBackgroundAndNarrativeResultsiveResults(dict(), f'Error loading the narrative graph {graph_uuid}: {msg}', 500)
